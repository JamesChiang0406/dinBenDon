    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container-fluid pl-5">
        <label class="navbar-brand" style="font-size: 1.5em;">
          <font color="#0d6efd">登入頁面</font>
        </label>
      </div>
    </nav>

    <div class="container position-relative" style="justify-items: center; align-content:center; height: 75vh;">
      <form method="POST" action="/login" class="border text-center" style="width: 30%; height: 60%;">
        @csrf
        <input type="hidden" name="whereLogin" value="user">
        ...
        <div class="container d-flex justify-content-center mt-5">
          <button type="submit" class="btn btn-primary" style="margin-right: 25px;">登入</button>
          <button type="reset" class="btn btn-secondary">重設</button>
        </div>
      </form>

      <div class="position-absolute" style="top: 5%; left: 80%">
        <a href="/admin/login" class="btn btn-outline-success" role="button" aria-pressed="true">後台登入</a>
      </div>
    </div>
  </div>
